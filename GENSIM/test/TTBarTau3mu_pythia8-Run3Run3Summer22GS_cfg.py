...
# with command line options: Configuration/GenProduction/python/GEN-GenericNoSmearGEN-00002-fragment.py --eventcontent LHE --outputCommand keep * --customise Configuration/DataProcessing/Utils.addMonitoring --datatier LHE --conditions 124X_mcRun3_2022_realistic_v12 --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step LHE,GEN:pgen_genonly --python_filename GEN-GenericNoSmearGEN-00002_1_cfg.py --fileout file:GEN-GenericNoSmearGEN-00002.root --number 232 --number_out 232 --no_exec --mc
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(232),      # 232
    output = cms.untracked.int32(232)      # 232
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TTBarTau3mu_pythia8-Run3_fragment.py nevts:232'),    # 232         # chiara
...
#    ),
#    fileName = cms.untracked.string('TTBarTau3mu_pythia8-Run3Run3Summer22GS.root'),
...
#process.LHEoutput.outputCommands.append('keep *')
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(232),      # 232
