...
# with command line options: Configuration/GenProduction/python/WTau3Mu_MTau1650_pythia8-Run3_fragment.py --eventcontent RAWSIM --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run3 --python_filename WTau3Mu_MTau1650_pythia8-Run3Run3Summer22GS_cfg.py --fileout WTau3Mu_MTau1650_pythia8-Run3_Run3Summer22GS.root --mc --no_exec --number 1000 --number_out 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/WTau3Mu_MTau1650_pythia8-Run3_fragment.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('WTau3Mu_MTau1650_pythia8-Run3_Run3Summer22GS.root'),
