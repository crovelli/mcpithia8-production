...
# with command line options: Configuration/GenProduction/python/FragmentB3munu.py --eventcontent RAWSIM --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run3 --python_filename FragmentB3munu.pyRun3Summer22GS_cfg.py --fileout FragmentB3munu.py_Run3Summer22GS.root --mc --no_exec --number 1000000 --number_out 1000000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/FragmentB3munu.py nevts:1000000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('B3munu_Run3Summer22GS.root'),
...
process.OneNeutrinoFilter = cms.EDFilter("MCMultiParticleFilter",
...
process.ThreeMuonFilter = cms.EDFilter("MCMultiParticleFilter",
    AcceptMore = cms.bool(True),
    EtaMax = cms.vdouble(2.5),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.ThreeMuonFilter+process.OneNeutrinoFilter)
