...
if __name__ == '__main__':
    ...
    step            = 'DRPremix' # DIGI,DATAMIX,L1,DIGI2RAW,HLT:xxx
    ...
    dataset_name    = '_'.join([process_name, tag, 'TuneCP5_13p6TeV_pythia8', campaign+step, version])
    ...
    # DBS is 'global' for public productions, 'phys03' for private productions
    ...
    config.JobType.maxMemoryMB = 5000 # 2500 (default for single core) ; a good configuration for multi-thread is 5000 with 4 cores
    config.JobType.numCores=4         # for multithread ; comment to switch off.  If ON, need the corresponding line in the cfg
